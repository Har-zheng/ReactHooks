...
const Filter = memo(props => {
  const { name, checked, value, dispatch, toggle } = props;
  return (
...
const Option = memo(function(props) {
  const { title, options, checkedMap, dispatch, update } = props;
...
BottomModal.propTypes = {
  ...
  checkedDepartStations: PropTypes.array.isRequired,
  checkedArriveStations: PropTypes.array.isRequired,
